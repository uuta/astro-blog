...
export function Card({ post }: Props) {
  ...
  const ZennContent = () => (
    <div className="ml-2 inline-flex items-center gap-1.5 text-sm opacity-70">
      <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 text-skin-zenn">
        <path
          fill="currentColor"
  ...
  return (
    <li className="my-6">
      <a
        href={href}
        className="inline text-lg font-medium text-skin-accent decoration-dashed underline-offset-4 focus-visible:no-underline focus-visible:underline-offset-0"
